...
//                                         feedback).
//
//   3.59    2007-06-13  Anthony Garrett  Added Tahoma to font list of
...
//******************************************************************************
    ...
    document.writeln(
        '<style type="text/css">' +
            ...
            '/* Calendar background */' +
            'table.scw                  {background-color:  #64656a;}' +
            '/* Drag Handle */' +
            'td.scwDrag                 {background-color:  #9999CC;' +
                                        'color:             #CCCCFF;}' +
            '/* Week number heading */' +
            'td.scwWeekNumberHead       {color:             #FFF5FF;}' +
            '/* Week day headings */' +
            'td.scwWeek                 {color:             #CCCCCC;}' +
            '/* Week numbers */' +
            'td.scwWeekNo               {background-color:  #eaeaea;' +
                                        'color:             #CCCCCC;}' +
            '/* Enabled Days */' +
            '/* Week Day */' +
            'td.scwCells                {background-color:  #eaeaea;' +
                                        'color:             #000000;}' +
            '/* Day matching the input date */' +
            'td.scwInputDate            {background-color:  #eaeaea;' +
                                        'color:             #FF0000;}' +
            '/* Weekend Day */' +
            'td.scwCellsWeekend         {background-color:  #eaeaea;' +
                                        'color:             #CC6666;}' +
            '/* Day outside the current month */' +
            'td.scwCellsExMonth         {background-color:  #f3f3f3;' +
                                        'color:             #666666;}' +
            '/* Today selector */' +
            'td.scwNow                  {background-color:  #606166;' +
                                        'color:             #FFFFFF;}' +
            '/* Clear Button */' +
            ...
            '/* Active cells */' +
            'td.scwCells:hover,' +
            'td.scwCellsHover           {background-color:  #66a9ba;' +
                                        'cursor:            pointer;' +
                                        'color:             #000000;}' +
            '/* Day matching the input date */' +
            'td.scwInputDate:hover,' +
            'td.scwInputDateHover       {background-color:  #66a9ba;' +
                                        'cursor:            pointer;' +
                                        'color:             #000000;}' +
            '/* Weekend cells */' +
            'td.scwCellsWeekend:hover,' +
            'td.scwCellsWeekendHover    {background-color:  #66a9ba;' +
                                        'cursor:            pointer;' +
                                        'color:             #000000;}' +
            '/* Day outside the current month */' +
            'td.scwCellsExMonth:hover,' +
            'td.scwCellsExMonthHover    {background-color:  #66a9ba;' +
                                        'cursor:            pointer;' +
                                        'color:             #000000;}' +
            '/* Today selector */' +
            'td.scwNow:hover,' +
            'td.scwNowHover             {color:             #66a9ba;' +
                                        'cursor:            pointer;' +
                                        'font-weight:       bold;}' +
            '/* Disabled cells */' +
            '/* Week Day */' +
            ...
            'td.scwCellsExMonthDisabled {background-color:  #999999;' +
                                        'color:             #666666;}' +
            'td.scwNowDisabled          {background-color:  #FFF5FF;' +
                                        'color:             #FFFFFF;}' +
        '</style>'
                    );
